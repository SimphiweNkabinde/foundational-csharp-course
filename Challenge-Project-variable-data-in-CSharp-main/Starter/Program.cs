        ...
        case "2":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (var searchTerm in dogCharacteristics)
                    {
                        if (dogDescription.Contains(searchTerm))
                        {
                            ...
                            for (int j = 2; j > -1; j--)
                            {
                                ...
                                {
                                    Console.Write($"\rsearching our dog: {ourAnimals[i, 3].Substring(8)} for {searchTerm.Trim()} {icon} {j}");
                                    Thread.Sleep(250);
                                }
                            ...
                            Console.WriteLine($"Our dog {ourAnimals[i, 3]} matches your search for {searchTerm}");
